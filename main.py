...
best_lecturer_1 = Lecturer('Oleg', 'Hasanov')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Kate', 'Haritonova')
best_lecturer_2.courses_attached += ['Git']

best_lecturer_3 = Lecturer('Ilmir', 'Mirdiev')
